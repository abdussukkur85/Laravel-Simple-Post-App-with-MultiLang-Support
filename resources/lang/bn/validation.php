...
return [
    ...
    */
    ...
    "between.array" => "এই কনটেন্টে অবশ্যই =>min থেকে =>max টি আইটেম থাকতে হবে",
    "between.file" => "এই ফাইল অবশ্যই =>min থেকে =>max কিলোবাইটের মধ্যে থাকতে হবে",
    "between.numeric" => "এর ভ্যালু অবশ্যই =>min থেকে =>max এর মধ্যে থাকতে হবে",
    "between.string" => "এটি =>min থেকে =>max ক্যারেক্টারের মধ্যে থাকতে হবে",
    ...
    "gt.array" => "এই কনটেন্টে অবশ্যই =>value এর বেশি আইটেম থাকতে হবে",
    "gt.file" => "এই ফাইল অবশ্যই =>value কিলোবাইটের বেশি হতে হবে",
    "gt.numeric" => "এর ভ্যালু অবশ্যই =>value এর বেশি হতে হবে",
    "gt.string" => "এটি অবশ্যই =>value ক্যারেক্টারের বেশি হতে হবে",
    "gte.array" => "এই কনটেন্টে অবশ্যই =>value বা এর বেশি আইটেম থাকতে হবে",
    "gte.file" => "এই ফাইল অবশ্যই =>value কিলোবাইটের সমান বা বেশি হতে হবে",
    "gte.numeric" => "এর ভ্যালু অবশ্যই =>value এর সমান বা বেশি হতে হবে",
    "gte.string" => "এটি অবশ্যই =>value ক্যারেক্টারের সমান বা বেশি হতে হবে",
    ...
    "lt.array" => "এই কনটেন্টে অবশ্যই =>value এর কম আইটেম থাকতে হবে",
    "lt.file" => "এই ফাইল অবশ্যই =>value কিলোবাইটের কম হতে হবে",
    "lt.numeric" => "এর ভ্যালু অবশ্যই =>value এর কম হতে হবে",
    "lt.string" => "এটি অবশ্যই =>value ক্যারেক্টারের কম হতে হবে",
    "lte.array" => "এই কনটেন্টে অবশ্যই =>value বা এর কম আইটেম থাকতে হবে",
    "lte.file" => "এই ফাইল অবশ্যই =>value কিলোবাইটের সমান বা কম হতে হবে",
    "lte.numeric" => "এর ভ্যালু অবশ্যই =>value এর সমান বা কম হতে হবে",
    "lte.string" => "এটি অবশ্যই =>value ক্যারেক্টারের সমান বা কম হতে হবে",
    "mac_address" => "মান অবশ্যই একটি বৈধ MAC ঠিকানা হতে হবে ।",
    "max.array" => "এই কনটেন্টে অবশ্যই =>max এর বেশি আইটেম থাকতে পারবে না",
    "max.file" => "এই ফাইল অবশ্যই =>max কিলোবাইটের বেশি হতে পারবে না",
    "max.numeric" => "এর ভ্যালু অবশ্যই =>max এর বেশি হতে পারবে না",
    "max.string" => "এটি অবশ্যই =>max ক্যারেক্টারের বেশি হতে পারবে না",
    "mimes" => "এই ধরনের একটি ফাইল হতে হবে=> =>values.",
    "mimetypes" => "এই ধরনের একটি ফাইল হতে হবে=> =>values.",
    "min.array" => "এই কনটেন্টে অবশ্যই =>min এর কম আইটেম থাকতে পারবে না",
    "min.file" => "এই ফাইল অবশ্যই =>min কিলোবাইটের কম হতে পারবে না",
    "min.numeric" => "এর ভ্যালু অবশ্যই =>min এর কম হতে পারবে না",
    "min.string" => "এটি অবশ্যই =>min ক্যারেক্টারের কম হতে পারবে না",
    ...
    "password.letters" => "এই ক্ষেত্রটি অন্তত একটি অক্ষর থাকতে হবে।",
    "password.mixed" => "এই ক্ষেত্রটি অন্তত একটি বড় হাতের এবং একটি ছোট হাতের অক্ষর থাকতে হবে।",
    "password.numbers" => "এই ক্ষেত্রটি অন্তত একটি নম্বর থাকতে হবে।",
    "password.symbols" => "এই ক্ষেত্রটি অন্তত একটি প্রতীক থাকতে হবে।",
    "password.uncompromised" => "প্রদত্ত ক্ষেত্র একটি ডেটা ফাঁসের মধ্যে পাওয়া গেছে। অনুগ্রহ করে একটি ভিন্ন ক্ষেত্র চয়ন করুন।",
    ...
    "size.file" => "এই ফাইল অবশ্যই =>size কিলোবাইটের হতে হবে",
    "size.numeric" => "এর ভ্যালু অবশ্যই =>size হতে হবে",
    "size.string" => "এটি অবশ্যই =>size ক্যারেক্টারের হতে হবে",
